...
| coordinates| Map        | Coordinates. Latitude and longitude.
...
| textFormat   | Select     | Format of the description text, "html" or "plain". Defaults to "html"
...
| country    | String     | A vgetConciergealid country code
| city       | String     | A valid city
| textFormat | Select     | Format of the description text "html", "plain", or "simplehtml". Defaults to "html"
...
| venueVisibility      | Select     | Controls the visibility of the event venue for non members of the hosting group. May be one of "public" or "members"
...
| rsvpOpen             | String     | Users with permission may set the RSVP open time for the event. The time may be specified in milliseconds since the epoch, or relative to the current time in the d/w/m format.
| venueVisibility      | Select     | Controls the visibility of venue. May be one of "public" or "members"
...
```
## Meetup.editSingleMember
Edit the authorized member's attributes

| Field          | Type       | Description
|----------------|------------|----------
| accessToken    | credentials| Required: OAuth2 Access Token
| id             | String     | Required: Memeber id
...
|--------------|------------|----------
| accessToken  | credentials| Required: OAuth2 Access Token
| rsvp         | Select     | Recomended: The RSVP setting - value must be either "yes", "no" or "waitlist"
